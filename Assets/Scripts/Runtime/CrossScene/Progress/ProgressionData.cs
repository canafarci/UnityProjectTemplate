...
namespace ProjectTemplate.Runtime.CrossScene.Progress
{
	...
	public class ProgressionData : SerializedScriptableObject
	{
		[SerializeField] private List<ProgressStep> ProgressSteps = new();

		public List<ProgressStep> progressSteps => ProgressSteps;

		[Space(100f)] [InfoBox("You can use the input field below to add new Unlockable IDs")] [ShowInInspector]
		private EnumFieldAdder<UnlockableID> _unlockableIDAdder = new();
	}
